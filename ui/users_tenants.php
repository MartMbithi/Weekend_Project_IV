                                ...
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $tenants->user_name; ?></td>
                                                    <td><?php echo $tenants->user_idno; ?></td>
                                                    <td><?php echo $tenants->user_email; ?></td>
                                                    <td><?php echo $tenants->user_phoneno; ?></td>
                                                    <td><?php echo $tenants->user_address; ?></td>
                                                    <td>
                                                        <a data-toggle="modal" href="#update_<?php echo $tenants->user_id; ?>" class="badge badge-primary"><i class="fas fa-edit"></i> Edit</a>
                                                        <a data-toggle="modal" href="#delete_<?php echo $tenants->user_id; ?>" class="badge badge-danger"><i class="fas fa-trash"></i> Delete</a>
                                                    </td>
                                                    <!-- Update Modal -->
                                                    <div class="modal fade fixed-right" id="update_<?php echo $tenants->user_id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog  modal-xl" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header align-items-center">
                                                                    <div class="text-bold">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="post" enctype="multipart/form-data" role="form">
                                                                        <div class="row">
                                                                            <div class="form-group col-md-12">
                                                                                <label for="">Full Name</label>
                                                                                <input type="hidden" value="<?php echo $tenants->user_id; ?>" required name="user_id" class="form-control" id="exampleInputEmail1">
                                                                                <input type="text" required name="user_name" value="<?php echo $tenants->user_name; ?>" class="form-control" id="exampleInputEmail1">
                                                                            </div>
                                                                            <div class="form-group col-md-4">
                                                                                <label for="">National ID Number</label>
                                                                                <input type="text" required name="user_idno" value="<?php echo $tenants->user_idno; ?>" class="form-control" id="exampleInputEmail1">
                                                                            </div>
                                                                            <div class="form-group col-md-4">
                                                                            ...
                                                                            <div class="form-group col-md-4">
                                                                                <label for="">Phone Number</label>
                                                                                <input type="text" required name="user_phoneno" value="<?php echo $tenants->user_phoneno; ?>" class="form-control" id="exampleInputEmail1">
                                                                            </div>
                                                                            <div class="form-group col-md-6">
                                                                                <label for="">Email Address</label>
                                                                                <input type="text" name="user_email" value="<?php echo $tenants->user_email; ?>" class="form-control" id="exampleInputEmail1">
                                                                            </div>
                                                                            <div class="form-group col-md-6">
                                                                                <label for="">Address</label>
                                                                                <input type="text" name="user_address" class="form-control" value="<?php echo $tenants->user_address; ?>" id="exampleInputEmail1">
                                                                            </div>
                                                                        </div>
                                                                        <div class="text-right">
                                                    ...
                                                    <!-- Delete Modal -->
                                                    <div class="modal fade" id="delete_<?php echo $tenants->user_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <form method="POST">
                                                                    <div class="modal-body text-center text-danger">
                                                                        <h4>Delete <?php echo $tenants->user_name; ?></h4>
                                                                        <br>
                                                                        <!-- Hide This -->
                                                                        <input type="hidden" name="user_id" value="<?php echo $tenants->user_id; ?>">
                                                                        <button type="button" class="text-center btn btn-success" data-dismiss="modal">No</button>
                                                                        <input type="submit" name="delete_tenant" value="Delete" class="text-center btn btn-danger">
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
