        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-8">
                            <h1 class="m-0 text-dark">Manage My Rental Agreements</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-4">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="my_dashboard">Home</a></li>
                                <li class="breadcrumb-item"><a href="">Rental Agreements</a></li>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a data-toggle="modal" href="#vacate_<?php echo $leases->rental_id; ?>" class="badge badge-warning"><i class="fas fa-ban"></i> Vacate Premise</a> <br>
                                                    </td>
                                                    <!-- Update Modal -->
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="post" enctype="multipart/form-data" role="form">
                                                                        ...
                                                                        <div class="text-right">
                                                                            <button type="submit" name="update_lease" class="btn btn-danger">Update</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="exampleModalLabel">CONFIRM VACATION</h5>
