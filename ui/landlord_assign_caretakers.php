                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control basic" name="assignment_property_id">
                                                ...
                                                $ret = "SELECT * FROM houses WHERE house_landlord_id = '$user_id' ";
                                                $stmt = $mysqli->prepare($ret);
                                                $stmt->execute(); //ok
                                                $res = $stmt->get_result();
                                                    ...
                                                    <div class="modal fade fixed-right" id="update_<?php echo $assn->assignment_id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog  modal-xl" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header align-items-center">
                                                                    <div class="text-bold">
                                                                        <h6 class="text-bold">Update <?php echo $assn->user_name . '' . $assn->house_name; ?> Allocation </h6>
                                                                    </div>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                    ...
                                                                    <form method="post" enctype="multipart/form-data" role="form">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="form-group col-md-6">
                                                                                <label for="">House Details</label>
                                                                                <select class="form-control basic" name="assignment_property_id">
                                                                                    <option value="<?php echo $assn->assignment_house_id; ?>"><?php echo $assn->house_code . ' ' . $assn->house_name; ?></option>
                                                                                    <?php
                                                                                    $properties_ret = "SELECT * FROM houses WHERE house_landlord_id = '$user_id'  ";
